...
export default async function MerchantsPage() {
    ...
    const dict = {
        ...
        directory: {
            ...
            title: originalDict.merchants.title,
            subtitle: originalDict.merchants.subtitle,
            addPartner: originalDict.merchants.addMerchant,
            searchPlaceholder: originalDict.merchants.searchPlaceholder,
            noPartnersFound: originalDict.merchants.noMerchantsFound,
            noPartnersSubtitle: originalDict.merchants.noMerchantsSubtitle,
            partnerCount: originalDict.merchants.merchantCount,
        }
    };
